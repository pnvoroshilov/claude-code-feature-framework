...
class MongoDBMemoryRepository(BaseRepository):
    ...
    async def intelligent_update_summary(
        self,
        project_id: str,
        summary: str,
        ...
        """
        Intelligent update of project summary with structured data.

        Completely replaces the summary with new comprehensive data
        generated by Claude's intelligent analysis.

        Args:
            project_id: Project ID
            summary: New comprehensive summary narrative
            key_decisions: List of key architectural/implementation decisions
            tech_stack: List of technologies used
            patterns: List of coding/architectural patterns
            gotchas: List of warnings and pitfalls
            embedding: Optional embedding vector for the summary
        ...
        # Prepare update data - completely replace all fields
        update_data = {
            "project_id": project_id,
            "summary": summary,
        ...
        if existing:
            ...
            # Create new document
            await summaries.insert_one(update_data)
